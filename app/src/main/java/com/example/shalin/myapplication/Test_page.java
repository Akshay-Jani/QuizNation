...
public class Test_page extends AppCompatActivity implements View.OnClickListener{
    ...
    String question,option1,option2,option3,option4,answer,selectedoption;
    ...
    private static final String QUEANS_URL="http://192.168.1.106/quizee/api/getQuestionsAPI.php";
            ...
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                switch (i){
                    case R.id.op1:
                        ...
                        Toast.makeText(Test_page.this,selectedoption,Toast.LENGTH_SHORT).show();
                        ...
                        StringRequest stringRequest = new StringRequest(Request.Method.POST, "http://192.168.1.106/quizee/check_answer.php", new Response.Listener<String>() {
                            ...
                            public void onErrorResponse(VolleyError error) {
                                ...
                                Toast.makeText(Test_page.this, "ERROR in sending", Toast.LENGTH_LONG).show();
                    ...
                    //    Volley.newRequestQueue(Test_page.this).add(stringRequest);
                        RequestQueue queue= Volley.newRequestQueue(Test_page.this);
...
*/
                    ...
                    case R.id.op2:
                      ...
                      //  Volley.newRequestQueue(Test_page.this).add(stringRequest2);
                        RequestQueue queue1= Volley.newRequestQueue(Test_page.this);
                    ...
                    case R.id.op3:
                       ...
                       // Volley.newRequestQueue(Test_page.this).add(stringRequest3);
                        RequestQueue queue3= Volley.newRequestQueue(Test_page.this);
                    ...
                    case R.id.op4:
                       ...
                       // Volley.newRequestQueue(Test_page.this).add(stringRequest4);
                        RequestQueue queue4= Volley.newRequestQueue(Test_page.this);
    ...
    //for updating timer after each second
    ...
    //after completion of exam timer will be paused
    ...
    public void answertrue(){
        ...
        StringRequest stringRequest5 = new StringRequest(Request.Method.POST, SELECTEDOPTION_URL, new Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(Test_page.this, "ERROR in sending for user", Toast.LENGTH_LONG).show();
                Toast.makeText(Test_page.this,Integer.toString(index), Toast.LENGTH_LONG).show();
        ...
        RequestQueue queue5= Volley.newRequestQueue(Test_page.this);
        ...
        switch(v.getId()){
                        ...
                        public void onResponse(String response) {
                            ...
                            new Response.ErrorListener() {
                                ...
                                public void onErrorResponse(VolleyError error) {
                                    ...
                                    Toast.makeText(Test_page.this, "ERROR in Fetching", Toast.LENGTH_LONG).show();
            ...
            case R.id.ibNext:
                if(index != 3) {
                   ...
                   Intent i = new Intent(Test_page.this,Performance.class);
                   startActivity(i);
                ...
                if(attempt_que < 50){
                    ...
                    Toast.makeText(Test_page.this,"You have completed the test",Toast.LENGTH_SHORT).show();
                    pauseTimer();
                }
